...
def evaluate(model, data_loader, device, num_classes):
    model.eval()
    confmat = util.ConfusionMatrix(num_classes)
...
def main(args):
    ...
    if args.test_only:
        ...
        confmat = evaluate(model, test_dataloader, device=device, num_classes=num_classes)
        print(confmat)
        return
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_one_epoch(model, criterion, optimizer, train_dataloader, lr_scheduler, device, epoch, args.print_freq, scaler)
        confmat = evaluate(model, test_dataloader, device=device, num_classes=num_classes)
        print(confmat)
        checkpoint = {
